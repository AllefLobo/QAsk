...
/**
 * Servlet implementation class ListarRespostaPerfilAnonimo
 */
@WebServlet("/listarRespostaPerfilAnonimo")
public class ListarRespostaPerfilAnonimo extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher rd = req.getRequestDispatcher("anonimaPerfil.jsp");
		rd.forward(req, resp);
	}
